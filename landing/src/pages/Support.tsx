    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Contact Information */}
          <div>
            <h2 className="text-2xl font-semibold mb-6 text-[#00CEC8]">Contact Us</h2>
            
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-full bg-[#00CEC8]/20 flex items-center justify-center flex-shrink-0">
                  <svg className="w-5 h-5 text-[#00CEC8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <div>
                  <h3 className="font-medium mb-1">Email Support</h3>
                  <a href="mailto:support@c-point.co" className="text-[#00CEC8] hover:underline">
                    support@c-point.co
                  </a>
            ...
            {/* FAQ Section */}
            <div className="mt-12">
              <h2 className="text-2xl font-semibold mb-6 text-[#00CEC8]">Frequently Asked Questions</h2>
              ...
              <div className="space-y-4">
                <details className="group bg-white/5 rounded-lg">
                  <summary className="flex justify-between items-center cursor-pointer p-4 font-medium">
                    ...
                    <span className="text-[#00CEC8] group-open:rotate-180 transition-transform">▼</span>
                  </summary>
          ...
          {/* Contact Form */}
          <div>
            <h2 className="text-2xl font-semibold mb-6 text-[#00CEC8]">Send us a Message</h2>
            
            {submitted ? (
              <div className="bg-[#00CEC8]/20 border border-[#00CEC8]/30 rounded-lg p-6 text-center">
                <svg className="w-12 h-12 text-[#00CEC8] mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                  ...
                  className="mt-4 text-[#00CEC8] hover:underline"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 focus:outline-none focus:border-[#00CEC8] transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 focus:outline-none focus:border-[#00CEC8] transition-colors resize-none"
                ...
                <button
                  type="submit"
                  className="w-full bg-[#00CEC8] text-black font-medium py-3 rounded-lg hover:bg-[#00B8B3] transition-colors"
                >
                  Send Message
                </button>
              </form>
      ...
      <footer className="border-t border-white/10 py-8 mt-12">
        <div className="container mx-auto px-4 text-center text-white/60">
          ...
          <div className="flex justify-center gap-6 mt-4">
            <Link to="/privacy" className="hover:text-[#00CEC8]">Privacy Policy</Link>
            <Link to="/terms" className="hover:text-[#00CEC8]">Terms of Service</Link>
            <Link to="/support" className="hover:text-[#00CEC8]">Support</Link>
          </div>
        </div>
      </footer>
    </div>
