export const AppShowcase = () => {
  return (
    <section id="experience" className="section-padding bg-primary/[0.1] overflow-hidden">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="body-lg">
            See your communities, a cross-network home feed, rich profiles, and messaging — a private
            layer for every group you belong to, without a public timeline for strangers.
          </p>
        </div>
        ...
        <div className="flex justify-center items-end gap-4 md:gap-8">
          ...
          <div className="w-[180px] sm:w-[220px] md:w-[260px] flex-shrink-0 transform hover:scale-105 transition-transform duration-500 z-10">
            ...
            <p className="text-center text-xs text-muted-foreground mt-3 font-medium">Profile</p>
          </div>
