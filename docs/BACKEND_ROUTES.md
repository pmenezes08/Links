...
| `/api/builder/create` | POST | `builder_create` | `backend/blueprints/builder.py:86` | builder create | `client/src/hooks/useBuilder.ts` (1) |
| `/api/builder/chat` | POST | `builder_chat` | `backend/blueprints/builder.py:126` | builder chat | `client/src/hooks/useBuilder.ts` (1) |
| `/api/builder/plan` | POST | `builder_plan` | `backend/blueprints/builder.py:159` | builder plan | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/iterate` | POST | `builder_iterate` | `backend/blueprints/builder.py:178` | builder iterate | *(no exact string match — may use helpers)* |
| `/api/builder/jobs/<int:job_id>` | GET | `builder_job_get` | `backend/blueprints/builder.py:220` | builder job get | *(no exact string match — may use helpers)* |
| `/api/internal/builder/jobs/<int:job_id>/run` | POST | `builder_job_run_internal` | `backend/blueprints/builder.py:245` | builder job run internal | *(no exact string match — may use helpers)* |
| `/api/cron/builder/sweep` | POST | `builder_sweep_cron` | `backend/blueprints/builder.py:258` | builder sweep cron | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/publish` | POST | `builder_publish` | `backend/blueprints/builder.py:267` | builder publish | *(no exact string match — may use helpers)* |
| `/api/builder/mine` | GET | `builder_mine` | `backend/blueprints/builder.py:299` | builder mine | `client/src/pages/BuilderPage.tsx` (1), `client/src/pages/MyBuilds.tsx` (1) |
| `/api/builder/<int:creation_id>` | GET | `builder_get` | `backend/blueprints/builder.py:309` | builder get | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>` | DELETE | `builder_delete` | `backend/blueprints/builder.py:336` | builder delete | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/history` | POST | `builder_save_history` | `backend/blueprints/builder.py:346` | builder save history | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/score` | POST | `builder_data_score` | `backend/blueprints/builder.py:415` | builder data score | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/rate` | POST | `builder_data_rate` | `backend/blueprints/builder.py:440` | builder data rate | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/save` | POST | `builder_data_save` | `backend/blueprints/builder.py:464` | builder data save | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/load` | GET | `builder_data_load` | `backend/blueprints/builder.py:489` | builder data load | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/images` | GET | `builder_data_images` | `backend/blueprints/builder.py:500` | builder data images | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/feed` | GET | `builder_data_feed` | `backend/blueprints/builder.py:534` | builder data feed | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/leaderboard` | GET | `builder_data_leaderboard` | `backend/blueprints/builder.py:563` | builder data leaderboard | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/results` | GET | `builder_data_results` | `backend/blueprints/builder.py:576` | builder data results | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/data/summary` | GET | `builder_data_summary` | `backend/blueprints/builder.py:587` | builder data summary | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/play` | POST | `builder_record_play` | `backend/blueprints/builder.py:614` | builder record play | *(no exact string match — may use helpers)* |
