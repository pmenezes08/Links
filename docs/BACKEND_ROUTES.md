...
| `/api/builder/create` | POST | `builder_create` | `backend/blueprints/builder.py:56` | builder create | `client/src/hooks/useBuilder.ts` (1) |
| `/api/builder/<int:creation_id>/iterate` | POST | `builder_iterate` | `backend/blueprints/builder.py:97` | builder iterate | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>/publish` | POST | `builder_publish` | `backend/blueprints/builder.py:141` | builder publish | *(no exact string match — may use helpers)* |
| `/api/builder/<int:creation_id>` | GET | `builder_get` | `backend/blueprints/builder.py:173` | builder get | *(no exact string match — may use helpers)* |
