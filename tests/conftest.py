...
_TRUNCATE_TABLES: List[str] = [
    ...
    "replies",
    "notifications",
    # Steve Builder tables — without these, gallery approvals, queued jobs,
    # pseudonyms, and scores leak across tests (the builder suite's
    # one-build-at-a-time and explore assertions are state-sensitive).
    "creations",
    "creation_data",
    "creation_shares",
    "creation_matches",
    "creation_match_moves",
    "builder_jobs",
    "builder_pseudonyms",
    "`groups`",
    "ai_usage_log",
    ...
    "push_tokens",
    "push_subscriptions",
    # Chat tables are shared across suites (DM suites, owner analytics'
    # members-communicating metric) but created by whichever test file — or
