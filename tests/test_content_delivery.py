...
class TestContentDelivery(unittest.TestCase):
    def test_append_sources_can_be_disabled(self):
        content = "Welcome to your weekly opinion roundup, brought to you by Steve! [FA_STAR]\n\nToday we will be discussing one perspective on future of work. See what you think.\n\n**Leave a comment:** Where do you land on this?"
