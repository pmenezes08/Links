    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="w-10 h-10 rounded-full flex items-center justify-center transition-colors bg-cpoint-turquoise hover:brightness-95 flex-shrink-0 active:scale-95"
          style={{ WebkitTapHighlightColor: 'transparent' }}
        >
          <i className={`fa-solid ${playing ? 'fa-pause' : 'fa-play'} text-c-text-primary text-sm pointer-events-none ${!playing ? 'ml-0.5' : ''}`} />
        </button>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between">
            <div className="text-[11px] text-c-text-tertiary tabular-nums">
