  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-zinc-700 bg-zinc-950">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Clean view • Powered by Trafilatura</p>
            </div>
          </div>
          <button 
            onClick={onClose}
        ...
        {/* Article Content */}
        <div className="flex-1 overflow-auto p-8 text-zinc-200 leading-relaxed">
          {loading && (
          ...
          {error && (
            <div className="bg-red-950/50 border border-red-900 rounded-2xl p-8 text-center">
          ...
          {article && !loading && (
            <>
              ...
              <div className="prose prose-invert prose-zinc max-w-none text-[15.5px] leading-[1.75] text-zinc-100">
                {article.content ? (
