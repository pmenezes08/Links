    ...
    <section className="mb-4 overflow-hidden rounded-3xl border border-cpoint-turquoise/25 bg-gradient-to-br from-cpoint-turquoise/16 via-c-bg-elevated to-c-bg-elevated p-4 shadow-c-card">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 gap-3">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-cpoint-turquoise text-black shadow-[0_0_30px_rgba(0,206,200,0.22)]">
            <i className="fa-solid fa-wand-magic-sparkles text-lg" aria-hidden="true" />
          </div>
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-2xl text-sm leading-relaxed text-c-text-secondary">
              Describe what you want. Steve makes it real: apps, websites, games, and tools you can share.
            </p>
          </div>
        </div>
