...
export default function Notifications(){
  ...
  async function onClick(n: Notif){
    ...
    if (url.startsWith('http') || url.startsWith('/')){
      ...
      if (url.startsWith('/post/') || url.startsWith('/community_feed_react/') || url.startsWith('/community/') || url.startsWith('/event/') || url.includes('/tasks_react') || url.includes('/polls_react') || url.includes('/useful_links_react') || url.startsWith('/admin_dashboard')){
