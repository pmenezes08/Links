    ...
    <div className="relative border-b border-white/10 py-2">
      <div className="relative flex items-start gap-2 px-3">
        <div className="relative w-10 flex-shrink-0" style={{ zIndex: 1 }}>
          ...
          {depth > 0 ? (
            <div className="absolute" style={{ left: '50%', transform: 'translateX(-1px)', top: '-10px', height: '10px', width: '2px', background: '#9ca3af', borderRadius: '9999px', pointerEvents: 'none' }} />
          ) : null}
          ...
          {(reply.children && reply.children.length) ? (
            <div className="absolute" style={{ left: '50%', transform: 'translateX(-1px)', top: '28px', height: '10px', width: '2px', background: '#9ca3af', borderRadius: '9999px', pointerEvents: 'none' }} />
          ) : null}
        </div>
