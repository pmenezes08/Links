    ...
    <div className="relative border-b border-white/10 py-2">
      <div className="relative flex items-start gap-2 px-3">
        <div className="relative w-10 flex-shrink-0" style={{ zIndex: 1 }}>
          ...
          {depth > 0 ? (
            <div className="absolute" style={{ left: '2px', top: '-16px', height: '32px', width: '2px', background: '#cbd5e1', borderRadius: '9999px', pointerEvents: 'none' }} />
          ) : null}
          ...
          {(reply.children && reply.children.length) ? (
            <div className="absolute" style={{ left: '2px', top: '28px', height: '32px', width: '2px', background: '#cbd5e1', borderRadius: '9999px', pointerEvents: 'none' }} />
          ) : null}
        </div>
