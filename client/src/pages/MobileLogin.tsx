          ...
          <>
            ...
            <div className="flex flex-col gap-3">
              {Capacitor.isNativePlatform() ? (
                ...
                <div
                  className={`w-full flex min-h-[48px] items-center justify-center ${googleLoading || isSubmitting ? 'opacity-50 pointer-events-none' : ''}`}
                >
                  <div
                    ref={gsiButtonRef}
                    className="w-full flex justify-center [&_.gsi-material-button]:max-w-full"
                  />
                </div>
              )}
