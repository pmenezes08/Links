...
const PLAN_DATA: Plan[] = [
  ...
  },
  {
    id: 'premium',
    name: 'Premium',
      description: 'Augment your social networking experience with AI.',
    monthly: 10,
    yearly: 100,
    cta: 'Buy Now',
    highlight: 'Popular',
  ...
  },
  {
    ...
    cta: 'Contact Sales',
    features: [
        'Unlimited community size and structure',
        'White-glove onboarding',
        'CPoint AI features available to all users in the community',
