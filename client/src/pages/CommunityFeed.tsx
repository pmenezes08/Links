    ...
    <div className="min-h-screen bg-black text-white pb-safe">
      ...
      {storyEditorOpen && storyEditorFiles.length > 0 && (
        ...
        >
          ...
          <div className="flex items-center justify-center overflow-hidden px-6" style={{ flex: '1 1 0%', minHeight: 0, pointerEvents: 'none', paddingTop: '48px', paddingBottom: keyboardHeight ? '20px' : (storyEditorFiles.length > 1 ? '90px' : '120px') }}>
            <div 
