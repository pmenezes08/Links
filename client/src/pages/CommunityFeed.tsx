    ...
    <div className="min-h-screen bg-black text-white pb-safe">
      ...
      {storyEditorOpen && storyEditorFiles.length > 0 && (
        ...
        >
          ...
          <div className="flex items-center justify-center overflow-hidden px-6" style={{ flex: '1 1 0%', minHeight: 0, pointerEvents: 'none', paddingTop: '24px', paddingBottom: keyboardHeight ? '20px' : (storyEditorFiles.length > 1 ? '30px' : '120px') }}>
            <div 
          ...
          {storyEditorFiles.length > 1 && (
            <div className="px-4 border-t border-white/10 bg-black" style={{ flexShrink: 0, marginBottom: '180px', paddingTop: '4px', paddingBottom: '4px' }}>
              <div className="flex gap-2 overflow-x-auto no-scrollbar items-center" style={{ margin: 0 }}>
