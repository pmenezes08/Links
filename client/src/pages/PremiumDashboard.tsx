    ...
    <div className="fixed inset-x-0 top-14 bottom-0 bg-[#0b0f10] text-white overflow-hidden z-0">
      ...
      <div className="fixed left-0 top-0 h-screen w-52 border-r border-[#333] bg-[#1a1a1a] hidden md:flex flex-col z-50">
        ...
        <nav className="flex-1 overflow-y-auto py-2">
          ...
          {(hasGymAccess || username.toLowerCase() === 'paulo') && <a className="block px-5 py-3 text-sm hover:bg-teal-700/20 hover:text-teal-300" href="/your_sports">Your Sports</a>}
      ...
      {mobileMenuOpen && (
        <div className="fixed top-14 left-0 right-0 z-40 border-t border-[#333] bg-[#1a1a1a] md:hidden">
          <nav className="flex flex-col">
            ...
            {(hasGymAccess || username.toLowerCase() === 'paulo') && <a className="px-5 py-3 border-b border-[#222]" href="/your_sports" onClick={() => setMobileMenuOpen(false)}>Your Sports</a>}
      ...
      <div className="h-full overflow-hidden">
        ...
        <div className="h-full flex items-center justify-center px-3 md:ml-52">
          <div className="w-full max-w-5xl grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            />
            {(hasGymAccess || username.toLowerCase() === 'paulo') && <Card iconClass="fa-solid fa-person-snowboarding" title="Your Sports" onClick={() => (location.assign('/your_sports'))} />}
          </div>
        </div>
      </div>
