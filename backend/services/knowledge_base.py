    ...
    return [
        ...
        },
        {
            ...
            "fields": [
                ...
                {"name": "paid_steve_package_feed_attach_web_search_tool", "label": "Feed Steve: attach web_search tool", "type": "boolean", "value": True,
                 "help": "After intent resolves (phrases / explicit-only / web default), pass Grok hosted web_search when this channel qualifies. Turn OFF to disable web lookups without deploy.", "group": "paid_steve_package"},
                {"name": "paid_steve_package_feed_attach_x_search_tool", "label": "Feed Steve: attach x_search tool", "type": "boolean", "value": True,
                 "help": "After intent resolves, pass Grok hosted x_search when this channel qualifies. Turn OFF to disable X lookups without deploy.", "group": "paid_steve_package"},
