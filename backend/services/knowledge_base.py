            ...
            "fields": [
                {
                    ...
                    "value": [
                        ...
                        {"title": "Monolith reduction — shared chat UI (DM + group threads)", "phase": "next", "status": "not_started", "effort": "L", "target_quarter": "2026-Q4", "notes": "Repo epic: `docs/MONOLITH_REDUCTION_ROADMAP.md` § Chat UI kernel. Cursor: `.cursor/rules/chat-surfaces.mdc`."},
                        {"title": "Monolith reduction — CommunityFeed & PostDetail decomposition", "phase": "next", "status": "not_started", "effort": "L", "target_quarter": "2026-Q4", "notes": "Repo: `docs/MONOLITH_REDUCTION_ROADMAP.md` § Community surfaces."},
