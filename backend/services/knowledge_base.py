            ...
            "fields": [
                {
                    ...
                    "value": [
                        ...
                        {"title": "Capacitor Network + Filesystem for offline media and phone memory", "area": "iOS", "phase": "now", "status": "completed", "effort": "M", "target_quarter": "2026-Q3", "notes": "Network for connectivity (cold start banner fix with isInitialized); Filesystem save button. Also fixed iOS preview broken image (errorCount/key + absolute error overlay in MessageImage, wrapped ChatMedia grid). Updated NetworkContext, OfflineBanner, PRODUCT_JOURNEYS.md. Matches plan.", "test": "native:offline-media", "test_status": "passed"},
