            ...
            "fields": [
                {
                    ...
                    "value": [
                        ...
                        {"title": "Capacitor Network + Filesystem for offline media and phone memory", "area": "iOS", "phase": "now", "status": "ongoing", "effort": "M", "target_quarter": "2026-Q3", "notes": "Network for connectivity detection (use local cache when offline); Filesystem for downloading R2 media to device Documents dir. Manual save button in ChatMedia viewer for safest permissions/ROI. Reduces server reliance, makes app feel native like WhatsApp gallery save. Update capacitor.config.ts, offlineDb.ts, PRODUCT_JOURNEYS.md.", "test": "native:offline-media", "test_status": "not_run"},
